...
function adicionaPublicacao() {
    ...
    comeceUmaPublicacao.innerHTML += `
                <div class="cabecario_publicacao">
                    <img class="icone_publicacao" src="icone_progamadores_br.jfif" alt="">
                    <h3 class="nome_pagina_publicacao"> Programadores Brasil
                        <p class="p_nome_pagina_publicacao">201.345 seguidores</p>
                        <p class="p_nome_pagina_publicacao">1 d</p>            
                    </h3>
                </div>
                <div class="legenda_publicacao">
                    <h4 class="h4_legenda_publicacao">Curso de Programação para Iniciantes -> Confira em <a>https://bit.ly/2vmg5A</a></h4>
                </div>
                <div>
                    <img class="imagem_feed_01" src="img_feed.jfif" alt="">
                </div>
